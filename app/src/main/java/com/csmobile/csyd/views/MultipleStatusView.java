package com.csmobile.csyd.views;
...
public class MultipleStatusView extends RelativeLayout {
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams, String msg) {
        ...
        if (null == mEmptyView) {
            mEmptyView = view;
            View emptyRetryView = mEmptyView.findViewById(R.id.empty_retry_view);
            TextView textView = (TextView) mEmptyView.findViewById(R.id.empty_view_tv);
    ...
    public final void showError(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mErrorView) {
            ...
            TextView textView = (TextView) mErrorView.findViewById(R.id.error_view_tv);
